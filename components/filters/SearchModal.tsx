              ...
              <div className="flex-1">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-3 py-2 pr-8 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#006699] focus:border-[#006699] bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
                    placeholder="0"
                  />
